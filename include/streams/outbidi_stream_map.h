/* include/stream/outbidi_stream_map.h 用于输出操作的双向数据流管理模块
 *
...
#ifndef _LIBGQUIC_STREAMS_OUTBIDI_STREAM_MAP_H
#define _LIBGQUIC_STREAMS_OUTBIDI_STREAM_MAP_H
...
struct gquic_outbidi_stream_map_s {
    pthread_mutex_t mtx;
...
#define GQUIC_OUTBIDI_STREAM_MAP_STREAM_CTOR(stream, map, n) ((map)->stream_ctor.cb((stream), (map)->stream_ctor.self, n))
#define GQUIC_OUTBIDI_STREAM_MAP_QUEUE_STREAM_ID_BLOCKED(frame, map) ((map)->queue_stream_id_blocked.cb((frame), (map)->queue_stream_id_blocked.self))
