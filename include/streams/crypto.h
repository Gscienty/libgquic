...
struct gquic_crypto_stream_manager_s {
    struct {
        void *self;
        int (*cb) (void *const, gquic_coroutine_t *const, const gquic_str_t *const, const u_int8_t);
    } handle_msg;
...
#define GQUIC_CRYPTO_STREAM_MANAGER_HANDLE_MSG(manage, co, data, enc_lv) \
    ((manage)->handle_msg.cb((manage)->handle_msg.self, (co), (data), (enc_lv)))
...
int gquic_crypto_stream_manager_ctor(gquic_crypto_stream_manager_t *const manager,
                                     ...
                                     int (*handle_msg_cb) (void *const, gquic_coroutine_t *const, const gquic_str_t *const, const u_int8_t),
