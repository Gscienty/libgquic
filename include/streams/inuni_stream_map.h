...
int gquic_inbidi_stream_map_accept_stream(gquic_stream_t **const str, gquic_inuni_stream_map_t *const str_map);
int gquic_inbidi_stream_map_get_or_open_stream(gquic_stream_t **const str, gquic_inuni_stream_map_t *const str_map, const u_int64_t num);
int gquic_inbidi_stream_map_delete_stream(gquic_inuni_stream_map_t *const str_map, const u_int64_t num);
int gquic_inbidi_stream_map_close(gquic_inuni_stream_map_t *const str_map, const int reason);
