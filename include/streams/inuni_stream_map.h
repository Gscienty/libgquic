/* include/stream/inuni_stream_map.h 用于读操作的单向数据流管理模块
 *
 ...
 *
 */
gquic_exception_t gquic_inuni_stream_map_close(gquic_inuni_stream_map_t *const str_map, const gquic_exception_t reason);
