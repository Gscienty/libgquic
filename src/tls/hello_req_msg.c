/* src/tls/hello_req_msg.c TLS HELLO_REQ record
 *
...
static gquic_exception_t gquic_tls_hello_req_msg_init(void *const msg);
static gquic_exception_t gquic_tls_hello_req_msg_dtor(void *const msg);
static ssize_t gquic_tls_hello_req_msg_size(const void *const msg);
static gquic_exception_t gquic_tls_hello_req_msg_serialize(const void *const msg, gquic_writer_str_t *const);
static gquic_exception_t gquic_tls_hello_req_msg_deserialize(void *const msg, gquic_reader_str_t *const);
...
static gquic_exception_t gquic_tls_hello_req_msg_serialize(const void *const msg, gquic_writer_str_t *const writer) {
...
static gquic_exception_t gquic_tls_hello_req_msg_deserialize(void *const msg, gquic_reader_str_t *const reader) {
