/* src/tls/cert_status_msg.c TLS CERT_STATUS record
 *
...
static gquic_exception_t gquic_tls_cert_status_msg_init(void *const msg);
static gquic_exception_t gquic_tls_cert_status_msg_dtor(void *const msg);
static ssize_t gquic_tls_cert_status_msg_size(const void *const msg);
static gquic_exception_t gquic_tls_cert_status_msg_serialize(const void *const msg, gquic_writer_str_t *const);
static gquic_exception_t gquic_tls_cert_status_msg_deserialize(void *const msg, gquic_reader_str_t *const);
...
static gquic_exception_t gquic_tls_cert_status_msg_serialize(const void *const msg, gquic_writer_str_t *const writer) {
    const gquic_tls_cert_status_msg_t *const spec = msg;
    ...
    GQUIC_ASSERT_FAST_RETURN(gquic_big_endian_writer_1byte(writer, GQUIC_TLS_HANDSHAKE_MSG_TYPE_CERT_STATUS));
    GQUIC_ASSERT_FAST_RETURN(__gquic_fill_str(writer, &spec->res, 3));

    GQUIC_PROCESS_DONE(GQUIC_SUCCESS);
}

static gquic_exception_t gquic_tls_cert_status_msg_deserialize(void *const msg, gquic_reader_str_t *const reader) {
    gquic_tls_cert_status_msg_t *const spec = msg;
