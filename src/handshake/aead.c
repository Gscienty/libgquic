...
int gquic_common_long_header_sealer_seal(gquic_str_t *const tag,
    ...
    if (sealer->use_handshake) {
        ...
        GQUIC_ASSERT_FAST_RETURN(gquic_long_header_sealer_seal(tag, cipher_text, &sealer->sealer.long_header_sealer, pn, plain_text, addata));
    }
...
int gquic_common_long_header_opener_open(gquic_str_t *const plain_text,
    ...
    if (opener->use_handshake) {
        ...
        GQUIC_ASSERT_FAST_RETURN(gquic_long_header_opener_open(plain_text, &opener->opener.long_header_opener, pn, tag, cipher_text, addata));
    }
